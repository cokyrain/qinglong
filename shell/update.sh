...
update_qinglong() {
    ...
    reset_romote_url ${dir_root} "${github_proxy_url}https://github.com/cokyrain/qinglong.git"
    ...
    local url="${github_proxy_url}https://github.com/cokyrain/qinglong-static.git"
